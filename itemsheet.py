...
class ItemSheet:
    ...
    def __init__(self, image_key, item_dir,  COLORKEY = pygame.Color('#0080ff') ): 
        ...
        self.frame_size_dict['icons.png'] = {'frames_wide': 14, 'frames_high': 30,  'author': '7soul1-d25c1np'}#420__pixel_art__icons_for_rpg_by_7soul1-d25c1np.png
        self.pixels_wide = self.surface.get_width() #How many pixels wide is image
        self.pixels_high = self.surface.get_height() #How many pixels high is image
        
        self.frames_wide = self.frame_size_dict[self.image_key]['frames_wide'] #How many frames wide is image
        self.frames_high = self.frame_size_dict[self.image_key]['frames_high'] #How many frames high is image
        self.frame_width  = self.pixels_wide/self.frames_wide#One frame's width
        self.frame_height = self.pixels_high/self.frames_high#One frame's height
        self.frames = []
